        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-3">
                        <label for="branch_name" class="control-label"><?php echo $this->lang->line('frm_branch_name'); ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-3">
                        <label for="address" class="control-label"><?php echo $this->lang->line('frm_branch_address'); ?></label>
                        <div class="form-group">
