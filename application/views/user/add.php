            ...
            <?php echo form_open('user/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-3">
						<label for="branch_id" class="control-label"><span class="text-danger">*</span><?php echo $this->lang->line('frm_branch'); ?></label>
						<div class="form-group">
							<select name="branch_id" class="form-control">
								...
								{
									$selected = ($branch['id'] == $this->input->post('branch_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-3">
						<label for="first_name" class="control-label"><span class="text-danger">*</span><?php echo $this->lang->line('frm_firstname'); ?></label>
						<div class="form-group">
					...
					<div class="col-md-3">
						<label for="last_name" class="control-label"><span class="text-danger">*</span><?php echo $this->lang->line('frm_lastname'); ?></label>
						<div class="form-group">
					...
					<div class="col-md-3">
						<label for="mobile_number" class="control-label"><?php echo $this->lang->line('frm_mobileno'); ?></label>
						<div class="form-group">
					...
					<div class="col-md-3">
						<label for="vehicle_type" class="control-label"><?php echo $this->lang->line('frm_vehicle_type'); ?></label>
						<div class="form-group">
							<input type="text" name="vehicle_type" value="<?php echo $this->input->post('vehicle_type'); ?>" class="form-control" id="vehicle_type" />
						</div>
					</div>
					<div class="col-md-3">
